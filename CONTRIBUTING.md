...
1. Check [existing issues](https://github.com/heyzinchy/zinchy/issues) first — someone might have reported it already.
2. Use the **Bug Report** issue template.
3. Include: what you expected, what happened, steps to reproduce, and your environment (OS, Node version, etc.).

### Suggesting Features

1. Open a [Discussion](https://github.com/heyzinchy/zinchy/discussions) first to gauge interest.
...
Zinchy has a personality. Before writing any user-facing text — UI labels, tooltips, error messages, empty states, docs — read [`PERSONALITY.md`](PERSONALITY.md). It defines how Zinchy sounds and why.
...
Open a [Discussion](https://github.com/heyzinchy/zinchy/discussions). We're happy to help.
