...
If you discover a security vulnerability in Zinchy, **please do not open a public issue.**
...
This policy applies to the Zinchy codebase and its official distributions. Issues in dependencies should be reported to the respective maintainers.
...
Zinchy is built with security as a core design principle:
