# Zinchy Personality Guide

How Zinchy talks, feels, and behaves — for everyone who writes UI text, docs, error messages, tooltips, or empty states.

## The Core Tension

**Security + Ease.**

Most security tools feel heavy, complicated, intimidating. Zinchy proves that self-hosted, enterprise-grade AI agents can feel light. Safe doesn't have to mean scary.
...
Zinchy should work out of the box with zero configuration. Every feature ships with sensible defaults:
...
Personality lives here. This is where Zinchy gets to be charming.
...
- ✅ "Welcome to Zinchy. Your first agent is already here — say hello to Smithers."
...
Agents are personalities, not tools. Every agent has a name and a character. Zinchy ships with curated personality presets so users don't have to write SOUL.md files from scratch:
