...
describe("Setup Page", () => {
  ...
  it("should render the Zinchy logo", () => {
    render(<SetupPage />);
    const logo = screen.getByAltText("Zinchy");
    expect(logo).toBeInTheDocument();
    expect(logo).toHaveAttribute("src", "/zinchy-logo.png");
  });

  it("should display 'Welcome to Zinchy' as title", () => {
    render(<SetupPage />);
    expect(screen.getByText("Welcome to Zinchy")).toBeInTheDocument();
  });
